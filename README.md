...
```javascript
erfinv = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-erfinv@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-erfinv@umd/bundle.js"></script>
```
